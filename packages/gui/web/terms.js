      ...
      <div class="mt-card">
        <div class="mt-hero">
          <span class="mt-logo" aria-hidden="true">
            <svg viewBox="0 0 100 100"><path d="M25 72V28l25 26 25-26v44" fill="none" stroke="#fff" stroke-width="9" stroke-linejoin="round" stroke-linecap="round"/></svg>
          </span>
          <span class="mt-kicker">Maker</span>
          <h2>Before you start</h2>
          <p class="mt-hero-sub">A quick heads-up before you build.</p>
        </div>
        <div class="mt-body">
